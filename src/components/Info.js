  ...
  return (
    ...
    >
      <div className="p-4">
        ...
        <h2 className="text-5xl text-white font-extrabold mb-4">What we do?</h2>
        <p className="text-white mb-4 leading-relaxed text-xl break-words">
          We offer seamless integration between your bank statements and Tally
