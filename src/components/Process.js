  ...
  return (
    <div className="container mx-auto p-8 grid">
      <div className="grid grid-cols-1 gap-8 items-center justify-center  max-md:grid-cols-1  max-md:border-0">
        <div className="grid grid-cols-2 border-2 p-5 rounded-xl border-slate-700 shadow bg-gradient-to-br from-slate-800 to-transparent  max-md:grid-cols-1  max-md:border-x-0 max-md:border-y-2 max-md:p-5">
          <div className="image ">
            <img
              src="clip1.gif"
              alt="Computer man"
          ...
          <div className="text mb-20">
            <h1 className="pl-5 text-2xl  text-white text-center ">
              <p>
                ...
                Log in to the service platform and navigate to the bank
                statement upload section. Choose your bank from the provided
                list. Upload the bank statement in PDF format.
              </p>
            </h1>
          </div>
        </div>
        <div className="grid grid-cols-2 border-2 p-5 rounded-xl border-slate-700 shadow bg-gradient-to-br from-slate-800 to-transparent  max-md:grid-cols-1">
          <div className="image">
            <img
              src="clip2.gif"
              alt="Computer man"
          ...
          <div className="pl-5 text mb-20">
            <h1 className="pl-5 text-2xl  text-white text-center ">
              <p>
                ...
                <br />
                Step 2: View transaction details. Once the statement is
                uploaded, click on the view icon to access the transaction
