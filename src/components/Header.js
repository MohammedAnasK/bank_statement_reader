  ...
  return (
    <header className="bg-amber-500 text-5xl fixed w-full z-50  shadow">
          ...
          <Popover className="relative">
            ...
            >
              <Popover.Panel className="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5">
                ...
                <div className="grid grid-cols-2 divide-x divide-gray-900/5 bg-gray-50 text-3xl">
      ...
      >
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-amber-500 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
